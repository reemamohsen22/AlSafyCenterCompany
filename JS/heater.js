...
//     // 🔥 تحويل الداتا لشكل مشروعك
//     const data = apiData.products.map(p => ({
//         id: p.id,
//         name: p.title,
//         img: p.thumbnail,
//         price: p.price,
//         old_price: p.price + 100, // اختياري عشان يظهر الخصم
//         category: p.category
//     }));
...
//             // 🔥 ربط الفئات القديمة بالجديدة
//             if (product.category === "smartphones") 
//                 renderProduct(swiper_heater_gas, product);

//             if (product.category === "laptops") 
//                 renderProduct(swiper_heater_electric, product);

//         } else {

//             if (filter === "heater_gas" && product.category === "smartphones") 
//                 renderProduct(swiper_heater_gas, product);

//             if (filter === "heater_electric" && product.category === "laptops") 
//                 renderProduct(swiper_heater_electric, product);
//         }
//     });
